...
echo.
echo [1;3;5;36m--- Computer iNfO ---[0m[32;1;3;5m
...
echo   [2;3mCreated by Sebastian Januchowski                  polsoft.ITS                   e-mail: polsoft.its@fastservice.com[0m
echo.
echo [1;3;5;36m--- System iNfO ---[0m[1;3;32m
echo.
systeminfo 
echo.[0m
...
echo    [2;3mCreated by Sebastian Januchowski                  polsoft.ITS                   e-mail: polsoft.its@fastservice.com[0m
echo.
echo [1;3;5;36m--- BIOS iNfO ---[0m[1;3;5;32m
...
echo    [2;3mCreated by Sebastian Januchowski                  polsoft.ITS                   e-mail: polsoft.its@fastservice.com[0m
echo.
echo [1;3;5;36m--- CPU iNfO ---[0m[1;3;5;32m
...
echo    [2;3mCreated by Sebastian Januchowski                  polsoft.ITS                   e-mail: polsoft.its@fastservice.com[0m
echo.
echo [1;3;5;36m--- Video Controller iNfO ---[0m[1;3;5;32m
...
echo    [5;2;3mCreated by Sebastian Januchowski                  polsoft.ITS                   e-mail: polsoft.its@fastservice.com[0m
echo.
echo [1;3;5;36m--- Net Adapter iNfO ---[0m[1;3;5;32m
...
echo    [5;2;3mCreated by Sebastian Januchowski                  polsoft.ITS                   e-mail: polsoft.its@fastservice.com[0m
echo.
echo [1;3;5;36m--- Drive and Volume iNfO ---[0m[1;3;5;32m
...
echo    [5;2;3mCreated by Sebastian Januchowski                  polsoft.ITS                   e-mail: polsoft.its@fastservice.com[0m
echo.
echo [1;3;5;36m--- List of Installed Drivers ---[0m[1;3;5;32m
driverquery
echo.[0m
echo    [5;2;3mCreated by Sebastian Januchowski                  polsoft.ITS                   e-mail: polsoft.its@fastservice.com[0m
pause >nul
