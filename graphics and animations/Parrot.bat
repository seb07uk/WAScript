...
call :c 02 "    \    .=!q!` "&call :c 05 "}.-~!q!'"&call :c 0D " "&call :c 05 "'-. '-..'  "&call :c 02 "__/" /n
...
echo(
echo.
echo    [3m[2mWritten by Sebastian Januchowski                  polsoft.ITS                   e-mail: polsoft.its@fastservice.com[0m[3m[6m
pause >nul
