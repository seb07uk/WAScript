...
@echo off
chcp 65001
title dotNET Runtime Installer and Updater v1.0.0 by Sebastian Januchowski
CLS
:menu
echo    Written by Sebastian Januchowski                  polsoft.ITS                   e-mail: polsoft.its@fastservice.com 
echo                                              ............................
echo                                              :      dotNET Runtime      :                   
echo            A[b]out                           :  Installer and Updater   :                              E[x]it
echo                                              :        ver.1.0.0         :
echo                                              :..........................:
echo.
echo      (1) .NET 3.1 Runtime                     (5) .NET 5.0 Runtime                     (9) .NET 6.0 Runtime
...
echo      (u)  ASP.NET 7.0 Core Runtime            (a)  ASP.NET 8.0 Core Runtime            (g)  ASP.NET 9.0 Core Runtime
echo.
echo                             ........................                       ........................
echo                             : Third-Party Packages :                       : .NET Install scripts :
echo                             :       Preview        :                       :......................:      
echo                             :......................:                           
echo                                                                                (z) PowerShell 
...
echo                        (l)  ASP.NET 10.0 Core Runtime Preview             web site (c) Microsoft .NET 
echo.
::
set /p op=">>> "
if %op%==1 goto 1
...
::
:b
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('dotNET Runtime Installer and Updater v1.0.0 [2025]','polsoft I.T.S. iNfO', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
cls
goto menu
:x
exit
